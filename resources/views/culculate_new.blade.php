...
<div class="col-md-5 mx-auto">
                <div class="card-header" style="padding: 0px 0px;">
                    <h4 class='text-center bg-info' style="font-size: 3.35rem;">収支入力画面</h1>
                </div>
                <div class="bg-info">
                    <div class="card-body">
                        <form action="{{ route('culculate.create') }}" method="post" class="form-inline">
                            @csrf
                            ...
                            <label for='amount'>お店</label>
                                ...
                                <input type='text' class='form-control' name='top' value="0" hidden/>
                                <input type='text' class='form-control' name='second' value="0" hidden/>
                                <input type='text' class='form-control' name='third' value="0" hidden/>
                            </div>
